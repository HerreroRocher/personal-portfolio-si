...
function EducationInfo() {
  return (
    <div>
      <h3>Education</h3>
      <p>The University of Manchester Manchester, UK</p>
      <p>BSc in Computer Science with Industrial Experience Sept 2023 ‑ Jul 2027</p>
      ...
      <p>Finchley Catholic High School London, UK</p>
      <p>A‑Levels, GCSEs Sept 2016 ‑ Jun 2023</p>
...
function ProjectsInfo() {
  return (
    <div>
      <h3>Projects</h3>
      <p>Magic Bakery (Java Bakery Game) Manchester, UK</p>
      <p>The University of Manchester Apr 2024 ‑ May 2024</p>
      ...
      <p>Food Finder (First Year Team Project using Node.js) Manchester, UK</p>
      <p>The University of Manchester Sept 2023 ‑ Apr 2024</p>
      ...
      <p>Dodger(Python Tkinter Game) Manchester, UK</p>
      <p>The University of Manchester Oct 2023 ‑ Nov 2023</p>
      ...
      <p>• Technical Skills: Python(Tkinter), File Manipulation, Git. Soft Skills: Time Management, Computational Thinking, Problem‑solving, Creativity.</p>
      <p>Jungle Shooter (AQA A‑Level Project using Python PyGame) London, UK</p>
      <p>Finchley Catholic High School Jun 2022 ‑ Feb 2023</p>
      ...
      <p>• Technical Skills: Python(Pygame), SQL. Soft Skills: Time Management, Presentation skills, Documentation, Testing.</p>
...
function SkillsInfo() {
  return (
    <div>
      <h3>Skills</h3>
      <p>Programming Python (PyGame, Tkinter), HTML/CSS, JavaScript (Node.js, React.js), SQL, Java, Git, Unity, C#, Data Parsing, Algorithm Development, State Management, API Interaction.</p>
      <p>Soft Skills Problem‑Solving, Analytical Thinking, Attention to Detail, Self‑Learning, Teamwork, Time Management, Communication, Technical Communication, Project Management, Resilience, Passion for Computing.</p>
      <p>Miscellaneous ARM Assembly Language, Microsoft Office, Command Prompt.</p>
    </div>
  );
}
